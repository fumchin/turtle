...
run: all
	...
	./extension_s Extension/if_test_success.ttl if_success_output.ps
	./extension_s Extension/if_test_success.ttl if_success_output.txt
...
clean:
	rm -f parse_s interp_s extension_s out_*.txt out_*.ps out_*.pdf if_*.ps if_*.txt
